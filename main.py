def on_on_overlap(sprite, otherSprite):
    ...
    controller.combos.set_trigger_type(TriggerType.DISABLED)
...
game.set_dialog_frame(img("""
    999999999999999999999999999999999999999999999999
        ...
        999999999999999999999999999999999999999999999999
"""))
game.show_long_text("long ago the one sword was found granting infenant pawor. but now its lost",
    DialogLayout.BOTTOM)
tiles.place_on_tile(oro, tiles.get_tile_location(10, 10))
oro = sprites.create(img("""
        . . . . . . f f f . . . . . . . 
            . . . . . f e e e f . . . . . . 
            . . . . f e f f f e f f . . . . 
            . . . f e f d d d f e f . . . . 
...
soro = sprites.create(img("""
    ...
    """),
    SpriteKind.player)
controller.player1.move_sprite(oro)
controller.player2.move_sprite(soro)
scene.camera_follow_sprite(oro)
...
music.play(music.create_song(hex("""
        0078000408020107001c00020a006400f4016400000400000000000000000000000000000000033c0000000400012a04000800012508000c00012010001400011d18001c00012220002400012728002c00012a3000340001273400380001203c004000011b
    """)),
